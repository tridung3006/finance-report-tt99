...
- Số đầu năm B01 được tính lũy kế đến ngày trước `01/01` của năm báo cáo.
- B02 và B03 so sánh với cùng kỳ năm trước: `startDate - 1 năm` đến `endDate - 1 năm`.
- Lợi nhuận chưa kết chuyển dùng cho B01 được tính từ B02 lũy kế từ đầu năm đến `endDate`.
...
Các tài khoản loại `5`, `6`, `8`, `9` không được đưa trực tiếp vào tài sản hoặc nguồn vốn. Nếu doanh nghiệp chưa chạy bút toán kết chuyển, ứng dụng tính lợi nhuận sau thuế chưa kết chuyển từ B02 lũy kế mã `60`, sau đó cộng vào:

- B01 mã `420` - Lợi nhuận sau thuế chưa phân phối.
- B01 mã `400` - Vốn chủ sở hữu.
- B01 mã `440` - Tổng cộng nguồn vốn.

Ứng dụng không còn lấy chênh lệch `280 - 440` để tự vá mã `420`. Sau điều chỉnh lợi nhuận, nếu `280 != 440`, validation vẫn báo lệch để kế toán kiểm tra mapping hoặc dữ liệu.
...
- Mã `01`: phát sinh Có `511`.
- Mã `02`: phát sinh Nợ `521`.
- Mã `10 = 01 - 02`.
- Mã `11`: giá vốn hàng bán `632`.
- Mã `20 = 10 - 11`.
...
B03 dùng phương pháp trực tiếp. Backend lấy các dòng tiền `111/112/113`, nhóm theo `journal_id` và tìm tài khoản đối ứng trong cùng bút toán. Chuyển tiền nội bộ giữa `111/112/113` bị loại khỏi lưu chuyển tiền tệ.
...
- Mã `04`, tiền ra: đối ứng `335`, `635`.
- Mã `05`, tiền ra: đối ứng `3334`, `821`.
- Mã `06`, tiền vào: đối ứng `331`, `138`, `244`, `338`, `711`, `141`.
...
- Mã `50 = 20 + 30 + 40`.
- Mã `70 = 50 + 60 + 61` và được đối chiếu với tiền cuối kỳ trên B01.
...
B09 tái sử dụng số đã xác định từ B01, B02 và B03 cho các bảng có thể chứng minh từ sổ cái, ví dụ tiền, phải thu, hàng tồn kho, phải trả, doanh thu, chi phí và lưu chuyển tiền.
